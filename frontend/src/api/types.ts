...
export type ImagePreview = Schemas['ImagePreview']
...
export type LatestThreadResponse = Schemas['LatestThreadResponse']
export type ThreadStatusResponse = Schemas['ThreadStatusResponse']
export type SiteStatsResponse = Schemas['SiteStatsResponse']
export type BoardStatsResponse = Schemas['BoardStatsResponse']
...
export type SimilarThreadResponse = Schemas['SimilarThreadResponse']
