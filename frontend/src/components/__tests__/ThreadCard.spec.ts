...
describe('ThreadCard', () => {
  ...
  it('lists the latest replies with their numbers', () => {
    const wrapper = mountCard(
      makeThread({
        last_replies: [
          { id: 11, name: 'Anonymous', body: 'can you see this', body_html: '<p>can you see this</p>', created_at: '2026-06-09T00:44:19Z' },
          { id: 12, name: 'Anonymous', body: 'yes', body_html: '<p>yes</p>', created_at: '2026-06-09T00:45:57Z' },
        ],
      }),
    )
    expect(wrapper.text()).toContain('Latest 2 replies')
    expect(wrapper.text()).toContain('No.11')
